...
다만, 같은 수를 찾고 0으로 만드는 부분이 있는데,  <span style="color:#2d3748;background-color:#fff5b1">temp 배열</span>을 만들어서 결과 값을 담아 놓은 후 BFS가 끝났을 때 값을 바꿔줘야했다 

<span style="color:red">→ 내가 주로 실수 많이 하는 부분이다</span>
